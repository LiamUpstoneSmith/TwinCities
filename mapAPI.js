function initialize(){
 ...
 const UniContent = 
                ...
                '<a href="Liverpool\LiverpoolLocations\Uni.html"><button type="button">More Info</button></a>' + 
                "</div>" +
                "</div>";
...
const safariContent = 
                ...
                '<a href="Liverpool\LiverpoolLocations\safari.html"><button type="button">More Info</button></a>' + 
                "</div>" +
                "</div>";
...
const galleryContent = 
                ...
                '<a href="Liverpool\LiverpoolLocations\gallery.html"><button type="button">More Info</button></a>' + 
                "</div>" +
                "</div>";
...
const parkContent = 
                ...
                '<a href=""><button type="button">More Info</button></a>' + 
                "</div>" +
                "</div>";
